    ...
    ReentrancyGuard
{
    ...
    function finalizeLaunch() external onlyOwner {
        ...
        (nativePlatformShare, tokenPlatformShare) = finalizePlatformFees(totalAmountRaised);
        ...
        uint256 remainingTokens = leftoverSaleTokens(totalAmountRaised, tokenPlatformShare);
