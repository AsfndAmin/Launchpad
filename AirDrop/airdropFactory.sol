...
contract DecentraLaunchFactory is Ownable, ReentrancyGuard {
    ...
    constructor(address _platformAddress, uint256 _platformOneTimeFee, uint8 _platformFee) {
     ...
     function deployPool(address _token, address _owner) external payable nonReentrant {
        require(
